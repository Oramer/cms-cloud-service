...
public class BaseOrder extends BaseEntity {
    ...
    private SysUser uorder;
    private BussReceiverMessage address;
    private List<ProductInfoVo> products;
    private int isInvoice;
    private List<BussBucketDetails> bprds;
    private List<BussBucketDetails> blrds;
    private BussStationPoster poster;
    private BussHtInfo htsq;
    ...
    public void setUorder(SysUser uorder) {
        this.uorder = uorder;
    }
    ...
    public void setBprds(List<BussBucketDetails> bprds) {
        this.bprds = bprds;
    }

    public void setBlrds(List<BussBucketDetails> blrds) {
        this.blrds = blrds;
    }
    ...
    public void setHtsq(BussHtInfo htsq) {
        this.htsq = htsq;
    }

    public boolean equals(Object o) {
        if (o == this) return true;
        if (!(o instanceof com.cms.buss_service.order.domain.BaseOrder)) return false;
        com.cms.buss_service.order.domain.BaseOrder other = (com.cms.buss_service.order.domain.BaseOrder) o;
        ...
        if ((this$realMoney == null) ? (other$realMoney != null) : !this$realMoney.equals(other$realMoney))
            return false;
        ...
        Object this$orderPersionName = getOrderPersionName(), other$orderPersionName = other.getOrderPersionName();
        if ((this$orderPersionName == null) ? (other$orderPersionName != null) : !this$orderPersionName.equals(other$orderPersionName))
            return false;
        Object this$uorder = getUorder(), other$uorder = other.getUorder();
        if ((this$uorder == null) ? (other$uorder != null) : !this$uorder.equals(other$uorder)) return false;
        ...
        if (getIsInvoice() != other.getIsInvoice()) return false;
        Object this$bprds =  getBprds(), other$bprds =  other.getBprds();
        if ((this$bprds == null) ? (other$bprds != null) : !this$bprds.equals(other$bprds)) return false;
        Object this$blrds =  getBlrds(), other$blrds =  other.getBlrds();
        if ((this$blrds == null) ? (other$blrds != null) : !this$blrds.equals(other$blrds)) return false;
        ...
        Object this$htsq = getHtsq(), other$htsq = other.getHtsq();
        return !((this$htsq == null) ? (other$htsq != null) : !this$htsq.equals(other$htsq));
    }
    @Override
    protected boolean canEqual(Object other) {
        return other instanceof com.cms.buss_service.order.domain.BaseOrder;
    }
    ...
    public int hashCode() {
        ...
        Object $realMoney = getRealMoney();
        result = result * 59 + (($realMoney == null) ? 43 : $realMoney.hashCode());
        ...
        Object $orderPersionName = getOrderPersionName();
        result = result * 59 + (($orderPersionName == null) ? 43 : $orderPersionName.hashCode());
        Object $uorder = getUorder();
        result = result * 59 + (($uorder == null) ? 43 : $uorder.hashCode());
        Object $address = getAddress();
        result = result * 59 + (($address == null) ? 43 : $address.hashCode());
        Object $products =  getProducts();
        result = result * 59 + (($products == null) ? 43 : $products.hashCode());
        result = result * 59 + getIsInvoice();
        Object $bprds =  getBprds();
        result = result * 59 + (($bprds == null) ? 43 : $bprds.hashCode());
        Object $blrds =  getBlrds();
        result = result * 59 + (($blrds == null) ? 43 : $blrds.hashCode());
        Object $poster = getPoster();
        result = result * 59 + (($poster == null) ? 43 : $poster.hashCode());
        Object $htsq = getHtsq();
        return result * 59 + (($htsq == null) ? 43 : $htsq.hashCode());
    }

    @Override
    public String toString() {
        return "BaseOrder(pk=" + getPk() + ", batchNo=" + getBatchNo() + ", orderTime=" + getOrderTime() + ", orderPersion=" + getOrderPersion() + ", stationId=" + getStationId() + ", orderAddressId=" + getOrderAddressId() + ", amount=" + getAmount() + ", realMoney=" + getRealMoney() + ", amountofmoney=" + getAmountofmoney() + ", singlePrice=" + getSinglePrice() + ", expressFee=" + getExpressFee() + ", isOvertime=" + getIsOvertime() + ", overtimeTime=" + getOvertimeTime() + ", orderRemark=" + getOrderRemark() + ", orderPayTime=" + getOrderPayTime() + ", completeTime=" + getCompleteTime() + ", orderType=" + getOrderType() + ", orderStatus=" + getOrderStatus() + ", payType=" + getPayType() + ", needMortgage=" + getNeedMortgage() + ", delFlag=" + getDelFlag() + ", cancelReason=" + getCancelReason() + ", no1=" + getNo1() + ", no2=" + getNo2() + ", no3=" + getNo3() + ", no4=" + getNo4() + ", no5=" + getNo5() + ", no6=" + getNo6() + ", no7=" + getNo7() + ", no8=" + getNo8() + ", no9=" + getNo9() + ", no10=" + getNo10() + ", no11=" + getNo11() + ", no12=" + getNo12() + ", no13=" + getNo13() + ", no14=" + getNo14() + ", no15=" + getNo15() + ", orderPersionName=" + getOrderPersionName() + ", uorder=" + getUorder() + ", address=" + getAddress() + ", products=" + getProducts() + ", isInvoice=" + getIsInvoice() + ", bprds=" + getBprds() + ", blrds=" + getBlrds() + ", poster=" + getPoster() + ", htsq=" + getHtsq() + ")";
    }
    ...
    public List<BussBucketDetails> getBprds() {
        /* 247 */
        return this.bprds;
    }

    public List<BussBucketDetails> getBlrds() {
        /* 249 */
        return this.blrds;
    }
...
/* Location:              C:\Users\Administrator\Desktop\cms-cloud-service.jar!\BOOT-INF\classes\com\cms\buss_service\order\domain\BaseOrder.class
