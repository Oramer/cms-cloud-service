...
public class BussProductBrand extends BaseEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof com.cms.buss_service.product.domain.BussProductBrand)) return false;
        com.cms.buss_service.product.domain.BussProductBrand other = (com.cms.buss_service.product.domain.BussProductBrand) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof com.cms.buss_service.product.domain.BussProductBrand;
    }
    @Override
    public int hashCode() {
        int PRIME = 59;
    ...
    public String toString() {
        return "BussProductBrand(pk=" + getPk() + ", stationId=" + getStationId() + ", brandName=" + getBrandName() + ", brandDesc=" + getBrandDesc() + ", brandLink=" + getBrandLink() + ", brandImages=" + getBrandImages() + ", reversion=" + getReversion() + ", no1=" + getNo1() + ", no2=" + getNo2() + ", no3=" + getNo3() + ", no4=" + getNo4() + ", no5=" + getNo5() + ", no6=" + getNo6() + ", no7=" + getNo7() + ", no8=" + getNo8() + ", no9=" + getNo9() + ", no10=" + getNo10() + ", no11=" + getNo11() + ", no12=" + getNo12() + ", no13=" + getNo13() + ", no14=" + getNo14() + ", no15=" + getNo15() + ")";
    }
...
/* Location:              C:\Users\Administrator\Desktop\cms-cloud-service.jar!\BOOT-INF\classes\com\cms\buss_service\product\domain\BussProductBrand.class
