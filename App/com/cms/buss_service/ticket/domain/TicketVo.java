...
public class TicketVo {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof com.cms.buss_service.ticket.domain.TicketVo)) {
            return false;
        }
        com.cms.buss_service.ticket.domain.TicketVo other = (com.cms.buss_service.ticket.domain.TicketVo) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof com.cms.buss_service.ticket.domain.TicketVo;
    }
    @Override
    public int hashCode() {
        int PRIME = 59;
