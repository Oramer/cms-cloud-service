...
public class TreeNode {
    ...
    private List<com.cms.base_service.common.model.TreeNode> children;

    public void setLabel(String label) {
        this.label = label;
    }

    public void setChildren(List<com.cms.base_service.common.model.TreeNode> children) {
        this.children = children;
    }

    public boolean equals(Object o) {
        if (o == this) return true;
        if (!(o instanceof com.cms.base_service.common.model.TreeNode)) return false;
        com.cms.base_service.common.model.TreeNode other = (com.cms.base_service.common.model.TreeNode) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof com.cms.base_service.common.model.TreeNode;
    }
    @Override
    public int hashCode() {
        int PRIME = 59;
