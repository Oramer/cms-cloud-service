 ...
 {
/* 19 */   private static final Logger log = LoggerFactory.getLogger(com.cms.base_service.common.filter.LoginFilter.class);
...
/* 28 */     log.error("当前请求路径为............................{}", request.getRequestURI());
/* 29 */     String token = request.getHeader("Authorization");
/* 30 */     if (StringUtils.isNotEmpty(token)) {
/* 31 */       boolean flag = this.jwtUtils.validateJWT(token).booleanValue();
/* 32 */       if (flag) {
/* 33 */         return true;
       }
     } 
/* 36 */     throw new AuthorizationException("【鉴权异常】:登录信息已过期或尚未登录");
   }
 }
