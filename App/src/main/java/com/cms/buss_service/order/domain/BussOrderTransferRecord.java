...
public class BussOrderTransferRecord extends BaseEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BussOrderTransferRecord)) return false;
        BussOrderTransferRecord other = (BussOrderTransferRecord) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof BussOrderTransferRecord;
    }
    @Override
    public int hashCode() {
        int PRIME = 59;
