...
public class BussStationInountRecord extends BaseEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BussStationInountRecord)) return false;
        BussStationInountRecord other = (BussStationInountRecord) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof BussStationInountRecord;
    }
    @Override
    public int hashCode() {
        int PRIME = 59;
