...
//    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WechatTransferBatchesParam)) return false;
        WechatTransferBatchesParam other = (WechatTransferBatchesParam) o;
...
//        Object this$transferDetailList =  getTransferDetailList(), other$transferDetailList =  other.getTransferDetailList();
    ...
    protected boolean canEqual(Object other) {
        return other instanceof WechatTransferBatchesParam;
    }
    @Override
    public int hashCode() {
        int PRIME = 59;
