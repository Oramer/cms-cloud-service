...
import com.cms.system_service.system.service.*;
...
public class SysLoginCtl {
    /*  38 */   private static final Logger log = LoggerFactory.getLogger(SysLoginCtl.class);
    ...
    public RestResult login(@RequestBody LoginBody loginUser) {
        ...
        map.put("token", token);
        /*  73 */
        return RestResult.ok().setData(map);
    }
    ...
    public RestResult getInfo() {
        /*  83 */
        SysUser user = this.sysUserService.selectUserById(SecurityUtils.getUid());
        ...
        /*  90 */
        this.redisCache.setCacheObject("sys_login_user:" + user.getUserName(), user, Long.valueOf(86400000L), TimeUnit.MINUTES);
        /*  91 */
        user.setIsSuperAdmin(SecurityUtils.isAdmin());
        /*  92 */
        Map<Object, Object> ajax = new HashMap<>();
        /*  93 */
        ajax.put("user", user);
        /*  94 */
        ...
        /*  96 */
        return RestResult.ok().setData(ajax);
    }
    ...
    public RestResult logout() {
        try {
            /* 107 */
            this.redisCache.deleteObject("sys_login_user:" + SecurityUtils.getUid());
            /* 108 */
            this.redisCache.deleteObject(Constants.Login_USER_REFRESH_KEY + SecurityUtils.getUid());
            /* 109 */
        } catch (Exception e) {
            /* 110 */
            log.error((e.getCause() != null) ? e.getCause().toString() : "登出失败");
        }
        /* 112 */
        return RestResult.ok().setMsg("登出成功");
    }
    ...
    public RestResult getCode(HttpServletResponse response) throws IOException {
        ...
        HashMap<String, Object> map = new HashMap<>();
        /* 119 */
        String uuid = IdUtils.get();
        /* 120 */
        map.put("uuid", uuid);
        /* 121 */
        boolean captchaOnOff = this.sysConfigService.selectCaptchaOnOff();
        /* 122 */
        map.put("captchaOnOff", Boolean.valueOf(captchaOnOff));
        /* 123 */
        if (!captchaOnOff) {
            /* 125 */
            return RestResult.ok().setData(map);
        ...
        /* 135 */
        String captchaType = this.sysConfigService.selectCaptchaType();
        /* 136 */
        ...
        /* 146 */
        this.redisCache.setCacheObject(verifyKey, code, Long.valueOf(2L), TimeUnit.MINUTES);
        /* 147 */
        FastByteArrayOutputStream os = new FastByteArrayOutputStream();
        try {
            /* 149 */
            ImageIO.write(image, "jpg", (OutputStream) os);
            /* 150 */
        } catch (IOException e) {
            /* 151 */
            return RestResult.fail().setMsg(e.getMessage());
        }
        /* 153 */
        map.put("uuid", uuid);
        /* 154 */
    ...
    public RestResult getRouters() {
        /* 165 */
        String userId = SecurityUtils.getUid();
        /* 166 */
        List<SysMenu> menus = this.menuService.selectMenuTreeByUserId(userId);
        /* 167 */
        return RestResult.ok(this.menuService.buildMenus(menus));
    }
}
